...
recipes.addShaped(<actuallyadditions:block_giant_chest_medium>, [[<prefab:item_bundle_of_timber>, <ore:ingotChrome>, <prefab:item_bundle_of_timber>],[<ore:ingotChrome>, <actuallyadditions:block_giant_chest>, <ore:ingotChrome>], [<prefab:item_bundle_of_timber>, <ore:ingotChrome>, <prefab:item_bundle_of_timber>]]);
...
recipes.addShaped(<gugu-utils:environmenthatch> * 1, [[<appliedenergistics2:material:48>, <minecraft:redstone_block>, <appliedenergistics2:material:48>], [<minecraft:redstone_block>, <additions:greedycraft-modularium_block>, <minecraft:redstone_block>],[<appliedenergistics2:material:48>, <minecraft:redstone_block>, <appliedenergistics2:material:48>]]);
recipes.addShaped(<gugu-utils:energyoutputport> * 1, [[<additions:greedycraft-modularium_block>, <contenttweaker:ingot_electrum_flux>, <additions:greedycraft-modularium_block>], [<contenttweaker:ingot_electrum_flux>, <modularmachinery:blockenergyoutputhatch:3>, <contenttweaker:ingot_electrum_flux>],[<additions:greedycraft-modularium_block>, <contenttweaker:ingot_electrum_flux>, <additions:greedycraft-modularium_block>]]);
